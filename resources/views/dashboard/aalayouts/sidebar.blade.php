<aside class="col-2 col-md-2 p-0 bg-black">
    <nav class="" id="sidebarMenu">
        <div class="pt-6">
            <ul class="nav nav-tabs mb-3" id="myTab0" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active"
                       id="home-tab0"  type="button" href="{{route('dashcounter')}}">
                        <i class="fas fa-tachometer-alt fa-fw me-3"></i><span>پیشخوان</span>
                    </a>
                    <ul class="absolute-menu submenu">
                        <li><a href="{{route('dashcounterhome')}}">خانه</a></li>
                        <li><a href="{{route('dashcounterupdate')}}">بروز رسانی</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab0" type="button" href="{{route('dashposts')}}">
                        <i class="fas fa-pen-nib fa-fw me-3"></i><span>نوشته </span>
                    </a>
                    <ul class="absolute-menu submenu">
                        <li><a href="{{route('dashposts')}}">همه نوشته ها</a></li>
                        <li><a href="{{route('posts.create')}}">افزودن نوشته</a></li>
                        <li><a href="{{route('categories.index')}}">دسته ها</a></li>
                        <li><a href="{{route('tags.index')}}">برچسب ها</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="media-tab0" role="tab" type="button" href="{{route('media.index')}}">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <ul class="absolute-menu submenu">
                        <li><a href="{{route('forms.index')}}">مشاهده همه</a></li>
                        <li><a href="{{route('forms.create')}}">افزودن جدید</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
